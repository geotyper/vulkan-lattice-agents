...
//
// Asked of a neighbourhood rather than of the world's whole floor area, which
// would make the frontier a global synchroniser and a layer cake the only
// buildable shape. A radius that spans the floor asks that old question again,
// so the old rule is reachable rather than deleted.
//
